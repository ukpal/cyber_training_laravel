            ...
            <div class="col-sm-6 text-right">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="{{app_url()}}yoddha-scrutiny/all">All</a>
                      <a class="dropdown-item" href="{{app_url()}}yoddha-scrutiny/pending">Pending</a>
                      <a class="dropdown-item" href="{{app_url()}}yoddha-scrutiny/rejected">Rejected</a>
                      <a class="dropdown-item" href="{{app_url()}}yoddha-scrutiny/approved">Approved</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody >
                    @if(!$yoddhas->isEmpty())
                        ...
                        <tr>
                            ...
                            <td><a href="/yoddha-details-scrutiny/{{$item->id}}" class="btn btn-info btn-sm">Details</a></td>                            
                        </tr>
                        @endforeach
                    @else 
                        <tr>
