            ...
            <div class="col-sm-4">
                <div class="row" style="height: 100%">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <a href="" class="btn btn-secondary" data-toggle='modal' data-target='#replyModal'>Reply</a>
                        @endif
                        {{-- @if ($task->status=='completed')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Reply to Task</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{url('/cyber-yoddha/reply-task')}}" enctype="multipart/form-data" method="POST">  
                    @csrf
